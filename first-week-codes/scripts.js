...
const lista = ['i am a big boy', 'b', 'c', 'd'];
console.log(lista.map(elemento => elemento.length)); //para cada elemento é mostrado no console o seu tamanho
...
const fora = () => (x=7, () => x+5) (); //menor forma de se escrever a função fora() da linha 320, onde x recebe 7 antes de fazer a soma
