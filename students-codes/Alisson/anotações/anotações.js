...
const listaAF = ['esse cara é maior','b','c','d']

console.log(listaAF.map(elemento => elemento.length))

// Arrow functions com if ternário
...
class Produto {
    ...
    detalhesDoProduto() {
        console.log(`O preço do produto ${this.nome} é ${this.preco}.`)
    }
}

const oculos = new Produto('oculos', 19.9)

console.log(oculos.nome)

oculos.detalhesDoProduto();

const meia = new Produto('Meia', 8.59)

meia.detalhesDoProduto()
...
console.log(camisa.outraMensagem('pequeno'));
...
todosOsParagrafos[1].classList.add('outra-classe')
...
// adiciona um evento que muda a cor de um parágrafo
